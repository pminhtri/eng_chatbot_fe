        ...
        <Box sx={{padding:"20px"}}>
            <TableContainer>
                  <Table sx={{ tableLayout: "fixed" }} aria-label="simple table">
                    ...
                    >
                      <TableRow>
                        <TableCell align="center" sx={{...CellStyle,width: "30%"}}>No</TableCell>
                        <TableCell align="center" sx={{...CellStyle,width: "50%"}}>Email user</TableCell>
                        <TableCell align="center" sx={{...CellStyle,width: "20%"}}>Total requests</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
